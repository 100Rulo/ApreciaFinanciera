<?php
	...
	if($instancia->editar($id_cfl , $nombre_cfl , $version_cfl , $autores_cfl , $fuentes_cfl , $fecha_cfl , $obj_cfl , $irq_cfl , $descripcion_cfl , $alternativa_cfl , $solucion_cfl , $importancia_cfl , $urgencia_cfl , $estado_cfl , $comentarios_cfl)){
